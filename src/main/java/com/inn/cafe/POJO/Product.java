...
@NamedQuery(name="Product.getAllCategory",query = "select new com.inn.cafe.wrapper.ProductWrapper(p.id,p.name,description,p.price,p.status,p.category.id,p.category.name) from Product p")
